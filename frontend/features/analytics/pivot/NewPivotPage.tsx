          ...
          <Card className="overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="flex items-center justify-end gap-1 px-3 py-2 border-b">
                ...
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleReset} aria-label="Reset">
                  <RotateCcw className="h-3.5 w-3.5" />
                </Button>
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleExportCsv} aria-label="Export CSV">
