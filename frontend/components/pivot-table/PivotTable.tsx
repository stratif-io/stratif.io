...
function buildLeafMeta(colDefs: { field?: string; headerName?: string; enableRowGroup?: boolean; enablePivot?: boolean; enableValue?: boolean; allowedAggFuncs?: string[] }[]): LeafMeta[] {
  return colDefs
    .filter((c) => c.field)
    .map((c) => ({
      colId: c.field!,
