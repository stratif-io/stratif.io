        ...
        >
          ...
          >
            {flipped && (
              <div
                className={cn(
                  'flex items-center justify-end gap-1.5 px-2 py-1.5 shrink-0 border-b',
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {queries.length > 1 && (
                    <span
                      className={cn('ml-2 font-normal', dark ? 'text-slate-500' : 'text-slate-400')}
                    >
