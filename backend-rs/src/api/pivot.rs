...
pub async fn get_pivot(State(_state): State<AppState>) -> StatusCode { StatusCode::NOT_IMPLEMENTED }
pub async fn get_pivot_grid(State(_state): State<AppState>) -> StatusCode { StatusCode::NOT_IMPLEMENTED }
