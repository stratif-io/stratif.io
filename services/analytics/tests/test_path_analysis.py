...
from services.analytics.api.paths import get_paths
from services.analytics.services.connection_executor import AnalyticsDatabase
from services.analytics.services.path_analyzer import (
    PathAnalyzer,
    PathAnalyzerError,
...
class TestPathAnalysisCountingModeAPI:
    def test_api_produces_contains_query(self):
        db = CapturingDB()
        from services.analytics.api.paths import get_path_analysis
