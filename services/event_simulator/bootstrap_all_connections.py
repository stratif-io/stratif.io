...
from services.analytics.api.connections.schema_detect import (
    _suggest_fields,
    assign_categories,
)
from services.analytics.backends import get_backend
from services.analytics.backends.base import SchemaInfo
...
from services.analytics.services.crypto import encrypt_credentials
...
SEEDER_MODULES = {
    "duckdb": "services.event_simulator.seeder_duckdb",
    "sqlite": "services.event_simulator.seeder_sqlite",
    "postgresql": "services.event_simulator.seeder_postgresql",
    "clickhouse": "services.event_simulator.seeder_clickhouse",
    "databricks": "services.event_simulator.seeder_databricks",
}
